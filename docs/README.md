...
The following files are generated by project scripts and are intentionally kept for now:

- `v3/v3-standalone-test.html` is rebuilt by `npm run build:v3`.
- `v3/admin-editor-standalone.html` is rebuilt by `npm run build:admin`.

Do not hand-edit generated standalone files. Update the source files and rebuild instead.
