...
const BMP_OPTIONS_DEFAULT = [
  ...
  { id: '10C', name: "Purple-Roof (Vegetated) 4+1+1", areaType: 'sloped_roof_or_flat_deck', unitPrice: 39.30, specs: { soilDepth: 4, soilPorosity: 0.20, nmwDepth: 1, nmwPorosity: 0.93, nmwRetentionPct: 0.40, hcDepth: 1, hcVoidRatio: 0.95, dlDepth: 0.2, dlPorosity: 0.93, spaceLoss: 0.05 }, extra: { pricingMode: 'black', pricingUpgrade: 18.5, pricingBase: 43.5 } },
  { id: '10D', name: "Purple-Roof (Vegetated) 4+1+3", areaType: 'sloped_roof_or_flat_deck', unitPrice: 41.80, specs: { soilDepth: 4, soilPorosity: 0.20, nmwDepth: 1, nmwPorosity: 0.93, nmwRetentionPct: 0.40, hcDepth: 3, hcVoidRatio: 0.95, dlDepth: 0.2, dlPorosity: 0.93, spaceLoss: 0.05 }, extra: { pricingMode: 'black', pricingUpgrade: 20.5, pricingBase: 45.5 } },
  ...
  { id: '11C', name: "Purple-Roof (Pavers) P+1+1", areaType: 'pavers_or_sloped_or_flat_deck', unitPrice: 34.45, specs: { hcDepth: 1, hcVoidRatio: 0.95, nmwDepth: 1, nmwRetentionPct: 0.40, spaceLoss: 0.05 }, extra: { tradPaverBasePrice: 22.82 } },
  { id: '11D', name: "Purple-Roof (Pavers) P+1+3", areaType: 'pavers_or_sloped_or_flat_deck', unitPrice: 43.13, specs: { hcDepth: 3, hcVoidRatio: 0.95, nmwDepth: 1, nmwRetentionPct: 0.40, spaceLoss: 0.05 }, extra: { tradPaverBasePrice: 22.82 } },
...
const BMP_IMAGES = {
  ...
  '10C': 'images/bmp-graphic-purple-veg-4-1-1.png',
  '10D': 'images/bmp-graphic-purple-veg-4-1-3.png',
  '10B': 'images/bmp-purple-veg-4-1-4.png',
  11: 'images/bmp-purple-paver-1-2.png',
  '11C': 'images/bmp-graphic-purple-paver-1-1.png',
  '11D': 'images/bmp-graphic-purple-paver-1-3.png',
